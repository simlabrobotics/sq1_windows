...
#ifndef _CANOPENDEF_H
#define _CANOPENDEF_H
...
////////////////////////////////////////////////
//  Define Homing method(INT8):
#define HM_NEGLIMITSW_INDEXPULSE		((char)1)
#define HM_POSLIMITSW_INDEXPULSE		((char)2)
#define HM_POSHOMESW_INDEXPULSE_N		((char)3)
#define HM_POSHOMESW_INDEXPULSE_P		((char)4)
#define HM_NEGHOMESW_INDEXPULSE_N		((char)5)
#define HM_NEGHOMESW_INDEXPULSE_P		((char)6)
#define HM_HOMESW_INDEXPULSE_1			((char)4)
#define HM_HOMESW_INDEXPULSE_2			((char)8)
#define HM_HOMESW_INDEXPULSE_3			((char)9)
#define HM_HOMESW_INDEXPULSE_4			((char)10)
#define HM_HOMESW_INDEXPULSE_5			((char)11)
#define HM_HOMESW_INDEXPULSE_6			((char)12)
#define HM_HOMESW_INDEXPULSE_7			((char)13)
#define HM_HOMESW_INDEXPULSE_8			((char)14)
#define HM_NEGLIMITSW					((char)17)
#define HM_POSLIMITSW					((char)18)
#define HM_POSHOMESW_N					((char)19)
#define HM_POSHOMESW_P					((char)20)
#define HM_NEGHOMESW_N					((char)21)
#define HM_NEGHOMESW_P					((char)22)
#define HM_HOMESW_1						((char)23)
#define HM_HOMESW_2						((char)24)
#define HM_HOMESW_3						((char)25)
#define HM_HOMESW_4						((char)26)
#define HM_HOMESW_5						((char)27)
#define HM_HOMESW_6						((char)28)
#define HM_HOMESW_7						((char)29)
#define HM_HOMESW_8						((char)30)
#define HM_INDEXPULSE_N					((char)33)
#define HM_INDEXPULSE_P					((char)34)
#define HM_CURRENT_POSITION				((char)35)
